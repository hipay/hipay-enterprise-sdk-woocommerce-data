...
ls bin/package/
sshpass -p $PASS_DEPLOY scp -P $PORT_SSH_DOCKER -o StrictHostKeyChecking=no  bin/package/hipay-enterprise-sdk-woocommerce-data*.zip root@docker-knock-auth.hipay.org:/deploy/project/artifactory/$CI_JOB_ID
